...
// minimum priority.
TxnSender.prototype.Send = function Send(method, request, callback) {
	request.Header().txn = this.txn
	
	var self = this

	// Send call through wrapped sender.
	this.wrapped.Send(method, request, function(err, res) {
		self.txn = res.txn
