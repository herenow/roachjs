...
// Isolation types
// What isolation to use SSI (Serializable Snapshot Instance) = 0
// or SI (Snapshot Instance) = 1. Default SSI (enum 0).                                            // Send proxies requests to wrapped kv.KVSender instance, taking care
// see: https://docs.google.com/document/d/11k2EmhLGSbViBvi6_zFEiKzuXxYF49ZuuDJLe6O8gBU/edit?pli=1#// to attach txn message to each request and update it on each
// see: https://docs.google.com/document/d/11k2EmhLGSbViBvi6_zFEiKzuXxYF49ZuuDJLe6O8gBU/edit?pli=1#// response. In the event of a transaction abort, reset txn with a
